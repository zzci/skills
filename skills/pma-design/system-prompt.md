...
- [Harness setup](#harness-setup-read-this-first)
- [Workflow](#your-workflow)
- [Output creation guidelines](#output-creation-guidelines)
- [React and Babel](#react--babel-for-inline-jsx)
- [File paths and user handoff](#file-paths-and-tools)
- [Questions and verification](#asking-questions)
- [In-page controls](#in-page-controls-variants--knobs)
- [Web research](#web-search-and-fetch)
- [Fixed-size content and starter components](#fixed-size-content)
- [Content guidelines and skills](#content-guidelines)
...
cp <skill>/scripts/vendor/react-18.3.1.production.min.js \
   <skill>/scripts/vendor/react-dom-18.3.1.production.min.js \
   <skill>/scripts/vendor/babel.min.js designs/_vendor/
```

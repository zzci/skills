...
| Web tool | Codex equivalent |
|---|---|
| `questions_v2` | A concise numbered list of questions in chat; wait for the user's reply. Structured ask tools are disabled in this environment — do not use `request_user_input` or similar. |
